...
class ModelFeatures:
    ...
    def __init__(
        ...
        self._column_definition = [
            ...
            ("volatility_log_10min",DataTypes.REAL_VALUED, InputTypes.KNOWN_INPUT),          ("volatility_log_30min",DataTypes.REAL_VALUED, InputTypes.KNOWN_INPUT),
...
#            ("log_1", DataTypes.REAL_VALUED, InputTypes.KNOWN_INPUT),
             ("Trade_Volume", DataTypes.REAL_VALUED, InputTypes.KNOWN_INPUT),
